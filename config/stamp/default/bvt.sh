...
LMS_URL=appkartu-learning.$BASE_URL
CMS_URL=appkartu-studio.$BASE_URL
...
# config/versions.yml
CONFIGURATION_REPO=https://github.com/APPKARTU/edx-configuration.git
CONFIGURATION_VERSION=oxa/master.fic
PLATFORM_REPO=https://github.com/APPKARTU/edx-platform.git
